package ajaxwithspringboot.controller;
...
import ajaxwithspringboot.model.Product;
import ajaxwithspringboot.model.ProductModel;
	...
	public ResponseEntity<Product> demo3(){
		...
		try{
			...
			ResponseEntity<Product> responseEntity 
				= new ResponseEntity<Product>(productm.find(),HttpStatus.OK);
	...
	public ResponseEntity<List<Product>> demo4(){
		...
		try{
			...
			ResponseEntity<List<Product>> responseEntity 
				= new ResponseEntity<List<Product>>(productm.findAll(),HttpStatus.OK);
